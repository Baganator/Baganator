...
local function OnBagSlotClick(self, button)
  ...
  elseif button == "RightButton" and addonTable.Config.Get(addonTable.Config.Options.SORT_METHOD) == "blizzard" then
...
local function OnBankSlotClick(self, button)
  if button == "RightButton" and addonTable.Config.Get(addonTable.Config.Options.SORT_METHOD) == "blizzard" then
