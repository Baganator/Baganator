local IsGuildSlotLocked = Baganator.Transfers.IsGuildItemLocked
...
function Baganator.Transfers.FromGuildToBags(toMove, bagIDs, bagTargets)
  ...
  bagTargets = Baganator.Transfers.SortChecksFirst(bagChecks, bagTargets)
