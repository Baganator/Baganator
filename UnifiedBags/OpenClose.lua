...
local event_drivers = {
  ...
  TRADE_SKILL_SHOW = { option = "tradeskill", isOpen = true, default = true },
  TRADE_SKILL_CLOSE = { option = "tradeskill", isOpen = false, default = true },
}
local interactions = {
  [IT.GuildBanker] = { option = "guild_bank", default = false },
  [IT.VoidStorageBanker] = {option = "void_storage", default = false },
  [IT.Auctioneer] = {option = "auction_house", default = true },
